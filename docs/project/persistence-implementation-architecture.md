...
Durable relational coverage now exists through `setup_lifecycle_mutation_record`, while shared-bundle and real-database integration coverage still stop at `routed_action_execution_envelope`:
