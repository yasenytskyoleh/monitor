...
- it now has a durable relational contract, but it still has no physical schema or migration layout
...
1. define the physical Prisma schema and SQL migration layout for `research_decision_approval`
2. add the adapter-backed repository and concrete Prisma adapter after the contract/schema are approved
...
- mixing setup-mutation or refinement execution behavior into the approval-schema step
